# Archived Calculation development proposal

Historical planning material; not the current specification. Excluded from the CLI and web documentation index. For current behavior see [Calculation authoring](../authoring/calculation.md).
