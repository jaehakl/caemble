...
- Measurement의 **Vars** 패널에서는 현재 Candidate의 `varsSchema` key를 선택해 scalar·1-D 막대 또는 2-D/N-D heatmap으로 값을 직접 편집할 수 있습니다. 편집값은 Viewer에 다시 평가되며 schema의 min/max를 벗어날 수 없습니다.
