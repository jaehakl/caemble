...
export const fluidDynamicsQuantityKindData = {
  ...
  'fluidDynamics.Compressibility': {
    ...
    applicableUnits: ['m2.N-1', 'bar-1', 'MPa-1', 'Pa-1', '%.bar-1'],
  },
  ...
  'fluidDynamics.LiquidVolume': {
    ...
    applicableUnits: ['[bbl_us]', '[cup_us]', 'cL', '[gal_br]', '[gal_us]', 'L', '[foz_us]', '[pt_us]', '[qt_us]'],
  },
  ...
  'fluidDynamics.PressureCoefficient': {
    ...
    applicableUnits: ['bar.K-1', 'hPa.K-1', 'kPa.K-1', 'MPa.K-1', 'Pa.K-1'],
  },
