...
export const scaleManifest = {
  ...
  properties: [
    { name: 'x', type: 'number', required: true, description: 'X축에 적용할 유한한 배율입니다.' },
    { name: 'y', type: 'number', required: true, description: 'Y축에 적용할 유한한 배율입니다.' },
    { name: 'z', type: 'number', required: true, description: 'Z축에 적용할 유한한 배율입니다.' },
  ],
