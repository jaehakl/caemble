  ...
  properties: [
    {
      ...
      description: 'parent 좌표계에서 적용할 정확히 세 개의 유한한 상대 이동 값입니다.',
    },
  ],
  ...
  properties: [
    {
      ...
      description: '오른손 법칙을 적용할 정확히 세 개의 유한한 값인 0이 아닌 회전축입니다.',
    },
    {
      name: 'angle',
      type: 'number',
      required: true,
      authoringValue: '0',
      description: 'radian 단위의 유한한 회전각입니다. degree 입력은 radians()로 변환합니다.',
    },
  ],
...
export const scaleManifest = {
  ...
  properties: [
    { name: 'x', type: 'number', required: true, authoringValue: '1', description: 'X축에 적용할 유한한 배율입니다.' },
    { name: 'y', type: 'number', required: true, authoringValue: '1', description: 'Y축에 적용할 유한한 배율입니다.' },
    { name: 'z', type: 'number', required: true, authoringValue: '1', description: 'Z축에 적용할 유한한 배율입니다.' },
  ],
