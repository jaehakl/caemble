...
with open_catalog() as catalog:
    data=catalog.runtime_slice(solvers=[('structural-mechanics','6.0.0')],quantity_kinds=['Length','thermodynamics.Temperature'],material_models=[])
    ...
    const tasks = {
      solid: {
        ...
        kernel: { name: 'structural-mechanics', version: '6.0.0' },
        config: {
          outputs: [
