...
import { invalidateRuntimeJobs } from '@/features/runtime/queryInvalidation'
import { jobsQueryOptions } from '@/features/runtime/queryOptions'
...
export function JobsWorkspace({
  ...
  const jobs = useQuery(jobsQueryOptions(auth.queryScope, activeOnly, auth.isAuthenticated))
  ...
  async function killJob(id: string) {
    ...
    try {
      ...
      await invalidateRuntimeJobs(queryClient, auth.queryScope)
    } catch (nextError) {
