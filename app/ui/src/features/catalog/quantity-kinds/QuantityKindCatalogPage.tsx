...
import { catalogQuantityKindQueryOptions, catalogQuantityKindsInfiniteQueryOptions } from '../queryOptions'
...
export function QuantityCatalog({
  ...
  const quantities = useInfiniteQuery(catalogQuantityKindsInfiniteQueryOptions(listQuery))
  const detail = useQuery({
    ...catalogQuantityKindQueryOptions(selectedName ?? '', Boolean(selectedName)),
    retry: false,
  })
