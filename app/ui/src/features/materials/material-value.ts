...
import type { MaterialPropertyValue, MaterialRelationValue } from '@/contracts/material'
import type { FloatDataDType } from '@/lib/cad/model'

export type { MaterialPropertyValue, MaterialRelationValue } from '@/contracts/material'
