...
export const manualDocsKnowledge: readonly DocsKnowledgeChunk[] = Object.freeze([
  ...
  manualChunk({
    ...
    content: [
      ...
      '',
      'Solver 호출이 실패하면 해당 호출이 만든 state와 artifact를 함께 rollback합니다. `sim.record()`로 브라우저에 도착한 결과도 실행이 끝날 때까지 provisional이며, 뒤 Task나 Python orchestration이 실패하면 모두 폐기됩니다.',
      '',
