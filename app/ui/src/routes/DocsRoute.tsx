...
import { GeometryCatalog } from '@/features/catalog/cad/CadCatalogPage'
...
import { QuantityCatalog } from '@/features/catalog/quantity-kinds/QuantityKindCatalogPage'
import { PhysicsCatalog } from '@/features/catalog/solvers/SolverCatalogPage'
import { defaultDocsSection, docsSectionIds, type DocsSectionId } from '@/features/docs/docsRoute'
import {
  catalogSearchKnowledge,
  getDocsKnowledge,
  searchDocsKnowledge,
  type DocsKnowledgeChunk,
} from '@/features/docs/docsKnowledge'
import { ManualDocsPage } from '@/features/docs/ManualDocsPage'
...
export function DocsPage() {
  ...
  const catalogSearch = useQuery(catalogSearchQueryOptions(deferredSearchQuery.trim(), 100, searchActive))
