...
export const manualDocsKnowledge: readonly DocsKnowledgeChunk[] = Object.freeze([
  ...
  manualChunk({
    ...
    content: [
      ...
      '### Data와 CSV',
      '',
      '**Data**에는 histogram, scalar profile과 100행 데이터 표가 있습니다. 표와 **선택 데이터 CSV**는 Data 설정에서 선택한 feature 및 CalculationData 요약 열만 사용하며 CalculationData 원본 tensor 배열은 포함하지 않습니다. **Prediction CSV**는 마지막으로 완료된 학습의 OOF 결과를 내보내며, What-if 입력만 바꿔도 학습 행 자체는 바뀌지 않습니다.',
    ].join('\n'),
  }),
  manualChunk({
