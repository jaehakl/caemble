...
export const manualDocsKnowledge: readonly DocsKnowledgeChunk[] = Object.freeze([
  ...
  manualChunk({
    ...
    content: [
      '상단 **Calculation** 메뉴는 왼쪽부터 Measurement/RecordedData/Calculation 목록, 3D Viewer, Source Editor, Output Chart를 표시합니다. 3D Viewer 아래에는 공통 AI Agent/Console 도크가 있으며 Calculation의 `console.log`와 실행 오류도 이 Console에 누적됩니다. 우측 열은 Output Chart와 Return 요약을 기본 65/35로 나눕니다. 열 경계, 왼쪽 세 영역, 하단 도크와 Chart/Return 경계는 드래그하거나 키보드 방향키로 조절하며 마지막 Workbench draft에 저장됩니다. Viewer를 확장하면 왼쪽 목록과 Viewer 열을 합쳐 full height Viewer로 사용하고, Source Editor와 Output 열은 계속 표시합니다.',
      '',
