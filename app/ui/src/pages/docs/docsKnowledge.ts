...
export const manualDocsKnowledge: readonly DocsKnowledgeChunk[] = Object.freeze([
  ...
  manualChunk({
    ...
    collapsed: true,
    content:
      '[Electro-Thermal Uniform Bar의 canonical bundle 열기](/docs?section=solvers&item=experiment:caemble:experiment/caemble/verified/electro-thermal-uniform-bar@1.0.0)',
  }),
  manualChunk({
  ...
  manualChunk({
    ...
    summary: '지지대, 수평 암, 백보드와 실제 annular rim을 canonical v11 문법으로 조립합니다.',
