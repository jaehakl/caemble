...
export const manualDocsKnowledge: readonly DocsKnowledgeChunk[] = Object.freeze([
  ...
  manualChunk({
    ...
    content: [
      'Experiment의 TSX 파일은 공개 package `@caemble/core`만 import합니다. 상대 경로, Task 간 import, 동적 `import()`, `require()`, URL과 다른 package는 지원하지 않습니다.',
      '',
      'Experiment 정의는 `experiment({...})`, 각 Task는 `defineTask({...})`를 default export합니다. 재사용할 Geometry component와 Material class는 해당 TSX Source 안에 선언하세요.',
      '',
