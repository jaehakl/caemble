...
const [modelRuntime, coreRuntime, kernelContractRuntime, kernelCatalogRuntime] = await Promise.all([
  ...
  loadBundledModule(path.join(root, 'src/lib/cad/simulation/kernelContract/index.ts')),
  loadBundledModule(path.join(root, 'src/lib/cad/simulation/kernels/index.ts')),
])
if (
