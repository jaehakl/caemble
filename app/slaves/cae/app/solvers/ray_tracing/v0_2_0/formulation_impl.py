...
from .outputs import Detector, PathCollector, build_detectors, build_ray_outputs
...
async def run(context: SolverInvocation) -> dict[str, Any]:
    ...
    collision_scene, meshes = await build_collision_scene(context, scene, parts)
