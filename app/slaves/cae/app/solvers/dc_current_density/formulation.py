...
def _cross_section(
    ...
    for row in range(shape[2]):
        ...
        for j in range(shape[1]):
            current_density = 0.0
            if surface_terminals and face_index == 0:
            ...
            elif surface_terminals and face_index == shape[0]:
...
def _gradient(
    ...
    for axis in range(3):
        ...
        minus_gradient = (
            ...
            if surface_terminals and axis == 0 and coordinates[axis] == 0
            else 0
        )
        plus_gradient = (
            ...
            if surface_terminals and axis == 0 and coordinates[axis] == shape[axis] - 1
            else 0
        )
