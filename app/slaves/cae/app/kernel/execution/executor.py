...
from app.kernel.execution.serialization import PayloadCodec, PicklePayloadCodec
...
class SolverExecutionTransaction(Generic[ResultT]):
    ...
    def commit(self) -> bool:
        return self._finish("committed", self._commit)

    def rollback(self) -> bool:
        return self._finish("rolled_back", self._rollback)

    def _finish(self, target: str, callback: Callable[[], None] | None) -> bool:
        with self._lock:
