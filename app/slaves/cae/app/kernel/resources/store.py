...
from app.kernel.api.state import StatePath
from app.kernel.resources.buffers import BufferLease, BufferStore
...
from app.kernel.resources.value_io import (
    ingest_value,
    materialize_value,
    resolve_value,
)
...
class ResourceStore:
    ...
    def resolve(self, ref: ResourceRef) -> Any:
        """Return immutable values with shared arrays and self-contained domains."""
        with self._lock:
