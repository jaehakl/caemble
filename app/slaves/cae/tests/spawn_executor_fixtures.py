...
scale_values = SolverImplementation(2, scale_values)
invalid_result = SolverImplementation(2, returns_mapping)
raises_error = SolverImplementation(2, raises_error)
wait_for_cancellation = SolverImplementation(2, wait_for_cancellation)
payload_size = SolverImplementation(2, payload_size)
blocks_forever = SolverImplementation(2, blocks_forever)
mmap_roundtrip = SolverImplementation(2, mmap_roundtrip)
crashes_process = SolverImplementation(2, crashes_process)
