...
def test_recorded_scalar_history_retains_physical_time_on_box_axes():
    ...
    leases = []
    try:
        handle = artifacts.publish(value, producer_task="structure", solver_name="structural-mechanics", solver_version="6.0.0", output_name="history", artifact_type=definition["artifactType"], state_revision=1)
