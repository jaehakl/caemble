...
from app.kernel.api import BundleValue, FieldValue, SolverInvocation
...
from tests.test_structural_analysis import spring_model
...
async def test_harmonic_entry_uses_reference_linear_problem_with_either_geometric_flag(monkeypatch):
    ...
    invocation = SolverInvocation(config, {}, {}, {}, None, None, solver_catalog.descriptor("structural-mechanics", "7.2.0"), task_name="structure")
